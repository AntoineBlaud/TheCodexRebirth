...
from tenet.taint_engine.sym_operation import bitwise_math
...
def initialize_global(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        # we have to create a wrapper to avoid calling getglobal multiple times, 
        # it slow down the execution
        def get_config(varname, func):
            global_val = globals()[varname]
            if (global_val):
                return global_val
...
class SymValue:
    ...
    def update_taint_id(self, target):
